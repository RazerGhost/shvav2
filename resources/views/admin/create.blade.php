        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <form method="POST" action="{{ route('admin.storeuser') }}" class="p-6">
                    ...
                    <!-- Tel Number -->
                    <div class="mb-4">
                        <label for="tel_number" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Tel Number') }}</label>
                    ...
                    <!-- Address -->
                    <div class="mb-4">
                        <label for="address" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Address') }}</label>
                    ...
                    <!-- City -->
                    <div class="mb-4">
                        <label for="city" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">{{ __('City') }}</label>
                    ...
                    <!-- State -->
                    <div class="mb-4">
                        <label for="state" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">{{ __('State') }}</label>
                    ...
                    <!-- Zip -->
                    <div class="mb-4">
                        <label for="zip" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Zip') }}</label>
